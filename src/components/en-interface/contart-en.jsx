  ...
  const fetchContracts = async () => {
    try {
      const response = await axios.get(
        `${Endponit()}/api/contrat_by_idEsn/?esnId=${localStorage.getItem(
          "id"
        )}`
      );
    ...
    <div style={{ padding: "0 24px" }}>
      <Tabs defaultActiveKey="1">
        ...
        <TabPane
          ...
          key="3"
        >
          <Card type="inner" title="Signature ESN">
            <Row justify="space-between" align="middle">
              <Col>
                <Space direction="vertical">
                  <Text strong>Représentant le ESN</Text>
                  ...
                  {contract.esn_trace && (
                    <div>
                      ...
                      <a
                        target="_blank"
                        href={Endponit() + "/media/" + contract.esn_trace}
                      >
                        Télécharger
                      </a>
                    </div>
              ...
              <Col>
                <Button
                  ...
                  disabled={contract.esn_trace}
                  size="large"
                >
                  {contract.esn_trace ? "Signé" : "Signer"}
                </Button>
              </Col>
            </Row>
          </Card>
